...
class DayOfWeek:
    ...
    def first_week_day(self) -> str:
        ...
        """
        return WEEK.days[datetime.date(self.year, self.month, 1).weekday()]

    def is_day_in_weekday(self, day: int, weekday: str) -> bool:
        return datetime.date(self.year, self.month, day).weekday() == WEEK.inverted_days()[weekday.capitalize()]
